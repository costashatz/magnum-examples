...
VoxelizationShader::VoxelizationShader() : VoxelBaseShader() {
    ...
    vert.addSource(rs.get("Voxelization.vert"));
    geom.addSource(rs.get("Voxelization.geom"));
    frag.addSource("#define MAX_LIGHTS " + std::to_string(_maxLights) + "\n")
        .addSource(rs.get("Voxelization.frag"));
